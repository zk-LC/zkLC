...
contract EscrowProcessor is Groth16Verifier, IProcessor, BaseProcessor {
    ...
    constructor(
        ...
        BaseProcessor(_ramp, _mailserverKeyHashAdapter, _emailFromAddress)
        Groth16Verifier()
    {}
    
    /* ============ External Functions ============ */
    function processProof(
        IProcessor.Proof calldata _proof
    )
        public
        override
        onlyRamp
